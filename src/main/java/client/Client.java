                ...
                switch (input) {
                    ...
                    case "9":
                        ...
                        System.out.println("Стоимость корзины покупателя - " +
                                customerController.getCustomersCartsTotalCost(id));
                        break;
                    case "10":
                        System.out.println("Введите идентификатор");
                        id = Long.parseLong(scanner.nextLine());
                        System.out.println("Средняя цена продукта в корзине - " +
                                customerController.getCustomersTotalAveragePrice(id));
                        break;
                    case "11":
                    ...
                    case "12":
                        ...
                        customerController.removeProductFromCart(customerId, productId);
                        break;
                    case "13":
                        System.out.println("Введите идентификатор покупателя");
                        id = Long.parseLong(scanner.nextLine());
                        customerController.clearAllProductsFromCart(id);
                        break;
                    case "0":
                        return;
                    default:
